                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date flight_dates" data-provide="datepicker">
                                            ...
                                            <input type="text" name="departure_date2" class="inline_block_btn departure_date vd_required" data-date-format="DD/MM/YYYY">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date flight_dates" data-provide="datepicker">
                                            ...
                                            <input type="text" name="landing_date2" class="inline_block_btn vd_required landing_date" data-date-format="DD/MM/YYYY">
                                        </div>
