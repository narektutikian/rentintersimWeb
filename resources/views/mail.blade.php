        ...
        <table border="0" cellpadding="20" cellspacing="0" height="100%" width="600" style="background: #ffffff; border: 1px solid #DDDDDD;">
            ...
            <tr>
                <td style="padding: 15px 10px;">
                    <img src="img/print_image.jpg" alt="" width="370" height="230" style="display: block; margin: 0 auto;">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 0; padding: 10px 10px;">
                    <div class="email_dates" style="display: inline-block; vertical-align: middle; width: 48%;">
                        ...
                        <div class="email_date_time" style="margin-top: 15px; color: #079fff; text-align: center; font-size: 15px; font-weight: normal; font-style: normal;">13/12/2016 17:05 </div>
                    ...
                    <div class="email_dates" style="display: inline-block; vertical-align: middle; width: 48%; margin-left: 4%;">
                        ...
                        <div class="email_date_time" style="margin-top: 15px; color: #079fff; text-align: center; font-size: 15px; font-weight: normal; font-style: normal;">18/01/2017 12:10 </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="padding: 3px 10px;">
                    <div style="height: 40px; line-height: 40px; padding: 0 15px; background: #079fff; color: #ffffff; font-size: 15px; font-weight: bold; font-style: normal; font-family: proxima_nova_rgregular, Arial, Helvetica, sans-serif;">Mail message: Order #124875</div>
                </td>
            </tr>
            <tr>
                <td>--
                    <br />Team CompanyName</td>
            </tr>
            </tbody>
        </table>
    </center>
